...
public class EmployeeController {
	...
	public String addNewEmployee(@ModelAttribute("newEmployee") Employee newEmployee,Model model, Principal principal) {
...
//	public String formAddNewEmployee(@ModelAttribute("newEmployee") Employee employeeToBeAdded) {
//		return "addEmployee";
//	}
